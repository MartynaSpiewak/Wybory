...
#'
#' Funkcja \code{facebook_posts_comments} ma na celu sciagniecie wszystkich postow
...
#' 
#' @usage facebook_posts_comments(id.kandydant.all)
...
#'
#'@examples
#' facebook_posts_comments(list("pawel tanajno" = 
#' c("469702339755768", "785096541556003", "390816184436123")))
#' 

facebook_posts_comments<-function(id.kandydant.all){
