...
#'  tmp <- facebook_like_w_czasie("Bronislaw Komorowski")
...
#'@examples
#' facebook_like_w_czasie("Janusz Korwin Mikke")

facebook_like_w_czasie <- function(name.id, from = as.Date("2015-01-01"), to = as.Date("2015-05-30")){
