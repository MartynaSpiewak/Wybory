...
#'
#' @param frame ramka danych, w której zawarte sa wysokosci wskaznikow dla kandydatow :"Podsumowanie_nasluch_kandydatow_miesiace.csv"
#' @param name wektor napisów, zawieraj¹cy nazwiska kandydatow
